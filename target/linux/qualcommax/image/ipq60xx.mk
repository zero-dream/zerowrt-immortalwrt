...
define Device/jdcloud_re-cs-07
	...
	DEVICE_PACKAGES := -ath11k-firmware-ipq6018 -ath11k-firmware-qcn9074-ddwrt -kmod-ath11k -kmod-ath11k-ahb -kmod-ath11k-pci -kmod-mac80211 -hostapd-common -wpad-openssl
	IMAGE/factory.bin := append-kernel | pad-to $$(KERNEL_SIZE) | append-rootfs | append-metadata
endef
