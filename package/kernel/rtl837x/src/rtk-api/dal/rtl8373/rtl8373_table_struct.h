...
typedef enum rtl8373_vlan_tblField_list_e { VLAN_TBL_RSVtf = 0, VLAN_TBL_IVL_SVLtf, VLAN_TBL_SVLAN_CHK_IVL_SVLtf, VLAN_TBL_FID_MSTItf, VLAN_TBL_UNTAGSETtf, VLAN_TBL_MBRtf, VLAN_TBLFIELD_LIST_END = 6 } rtl8373_vlan_tblField_list_t;

typedef enum rtl8373_l2_ipmcField_list_e { L2_IPMC_SIPtf = 0, L2_IPMC_DIPtf, L2_IPMC_L3LOOKUPtf, L2_IPMC_MBRtf, L2_IPMC_IGMPIDXtf, L2_IPMC_IGMPASICtf, L2_IPMCFIELD_LIST_END = 6 } rtl8373_l2_ipmcField_list_t;

typedef enum rtl8373_l2_mcField_list_e { L2_MC_MACtf = 0, L2_MC_VID_FIDtf, L2_MC_L3LOOKUPtf, L2_MC_IVL_SVLtf, L2_MC_MBRtf, L2_MC_IGMPIDXtf, L2_MC_IGMPASICtf, L2_MCFIELD_LIST_END = 7 } rtl8373_l2_mcField_list_t;

typedef enum rtl8373_l2_ucField_list_e { L2_UC_MACtf = 0, L2_UC_VID_FIDtf, L2_UC_L3LOOKUPtf, L2_UC_IVL_SVLtf, L2_UC_SPAtf, L2_UC_AGEtf, L2_UC_AUTH1Xtf, L2_UC_STATICtf, L2_UCFIELD_LIST_END = 8 } rtl8373_l2_ucField_list_t;
...
typedef enum rtk_table_list_e { VLAN_TBLt = 0, L2_IPMCt, L2_MCt, L2_UCt, IGMP_GROUP_TBLt, ACL_ACT_ENTRYt, ACL_RULE_DATAt, TABLE_LIST_END = 7 } rtk_table_list_t;
