...
typedef enum chip_mode_type_e { CHIP_RTL8373_MODE, CHIP_RTL8372_MODE, CHIP_RTL8224_MODE, CHIP_RTL8221B_MODE, CHIP_RTL8373N_MODE, CHIP_RTL8372N_MODE, CHIP_RTL8224N_MODE, CHIP_RTL8366U_MODE, CHIP_MODE_END } chip_mode_type_t;
/*
 * Symbol Definition
 */

typedef enum rtl8373_sds_id_e { SERDES_ID0 = 0, SERDES_ID1 = 1, SERDES_IDEND } rtl8373_sds_id_t;
 ...
 */
extern rtk_api_ret_t dal_rtl8373_switch_init(void);
 ...
 * Note:
 */
extern rtk_api_ret_t dal_rtl8373_switch_portMaxPktLen_set(rtk_port_t port, rtk_switch_maxPktLen_linkSpeed_t speed, rtk_uint32 cfgId);
 ...
 * Note:
 */
extern rtk_api_ret_t dal_rtl8373_switch_portMaxPktLen_get(rtk_port_t port, rtk_switch_maxPktLen_linkSpeed_t speed, rtk_uint32 *pCfgId);
 ...
 * Note:
 */
extern rtk_api_ret_t dal_rtl8373_switch_maxPktLenCfg_set(rtk_uint32 cfgId, rtk_uint32 pktLen);
 ...
 * Note:
 */
extern rtk_api_ret_t dal_rtl8373_switch_maxPktLenCfg_get(rtk_uint32 cfgId, rtk_uint32 *pPktLen);
 ...
 *      - ENABLE
 */
extern rtk_api_ret_t dal_rtl8373_switch_greenEthernet_set(rtk_enable_t enable);
 ...
 */
extern rtk_api_ret_t dal_rtl8373_switch_greenEthernet_get(rtk_enable_t *pEnable);
