...
extern struct rtk_gsw *rtl_gbl_priv;
...
enum RTL8370UG_TABLE_ACCESS_OP { TB_OP_READ = 0, TB_OP_WRITE };

enum RTL8370UG_TABLE_ACCESS_TARGET { TB_TARGET_ACLRULE = 1, TB_TARGET_ACLACT, TB_TARGET_CVLAN, TB_TARGET_L2, TB_TARGET_IGMP_GROUP, TB_TARGET_HSA, TB_TARGET_HSB };
